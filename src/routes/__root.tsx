...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "LateriteIQ — AI Laterite Stone Quality Inspector" },
      {
        name: "description",
        content:
          "Upload a photo of a laterite stone sample and get an instant AI-powered quality grade and inspection report.",
      },
